...
<%
ResultSet rs2=st1.executeQuery("select filename from uploads where ownerid='"+oid+"'");
%> 
...
while(rs2.next())
{
	...
	<tr>
            ...
            <form method="post" action="delete">
                <input type="hidden" name="nme" value="<%=data5%>"></input>
            <td><input type="button" name="id" value="Remove"></input></td>
            </form>
	</tr>
 <%
}
 ...
 %> 
  ...
  <div class="footer">
    <div class="footer_resize">
      <p class="lf">&copy; <a href="#">pdfs</a>.</p>     
